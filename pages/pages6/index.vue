...
<script>
	...
	export default {
		...
		mounted() {
			if (!this.mychart && !this.mychart2 && !this.mychart3) {
		...
		methods: {
			...
			init() {
				...
				option = {
					...
					series: [{
						data: [1458, 1833, 1482, 1529, 1737, 1228, 1143],
						type: 'line',
						smooth: true,
						symbol: 'none',
						lineStyle: {
